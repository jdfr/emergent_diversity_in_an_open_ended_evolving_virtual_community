function exhaustiveSearch05(Gvalues, Fvalues, ensayos)

stableParams = {...
  'tam_poblacion', {1}, 'variablePopSize', {true}, 'N', {inf}, 'initialPos', {5000}, ...
  'factorG', {1} 'treePlacementParam', {0}, 'treePlacementOffset', {100}, ...
  'plottingFactor', {10}, 'ensayos', {ensayos}, 'generaciones', {500}, 'stopIfTooTall', {10000}, 'tooLongEvTime', {1500}, ...
  'variableNumSonsMode', {'round#[0 0.5]'}, 'T.angle', {22}, ...
...
for m=1:numel(Gvalues)
  for n=1:numel(Fvalues)
    ...
    subdir = ['resultados' filesep 'systematicAlphaF1_05' filesep 'G' mat2str(Gvalues(m)) 'F' mat2str(Fvalues(n))];
