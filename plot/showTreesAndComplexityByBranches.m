function img = showTreesAndComplexityByBranches(poph, gen, P, compression, toFile)%, comps)
%script to generate the figure of genotype length / nbranches. The ids
%used are tailored to a specific siomulation in a specific generation,
%whose poph and corresponding PXXX.mat must be given as arguments (look in
%other scripts for instances of this function)
...
comps = [[80,] 91 100 125 [140,] 342  512 [ 777] [1184, 1467] [2046,] [4622,] 3267 [5696,] [7967,] [16948, 22693,]]';
...
comps = P.counts(idx,1);% comLZfigureLongitud(idx)';
lens  = lenGenome(idx);
...
function img = makeFigure(posx, posy, imgs, off, dms, xe, xtcks, xlab, ye, ytcks, ylab, offy, offs, offt, offtx, offty, imscale, paint, showText, idxToShow)
  ...
  [logmny logye logposy,logyticks, yticks]= calculateLogScaleTicks(10, ye, posy, true);
