function h = showEvolutionOfComplexityNEWCOMPLEXITY(basedir,numGenerations, comEspeciesAnte, comEspeciesSig, structcomplex)
...
[stdt fit1 fit2 fit3]=paintComplexityProto2(basedir,1,numGenerations, structcomplex);
hold on
...
line(1:numGenerations,polyval(fit1,1:numGenerations),'color', 'k','LineWidth',1);
line(1:numGenerations,polyval(fit2,1:numGenerations),'color', 'k','LineWidth',1);
...
function [stdt fit1 fit2 fit3]=paintComplexityProto2(basedir,GenI,GenF, structcomplex)
...
%     comLZfigureLongitud = eval(sprintf('comLZfigureLongitud%03d', i));
    comLZfigureLongitud = structcomplex.complexities{structcomplex.gs==i};
