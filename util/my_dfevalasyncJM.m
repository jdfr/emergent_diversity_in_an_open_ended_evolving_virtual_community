function jobObj = my_dfevalasyncJM(jobMgr, dfcn, numArgOut, varargin)
% customized version of dfevalasync, also using a pre-existing job manager
...
% find a job manager.
%jobMgr = findResource('scheduler', 'type', 'torque', findRArgs{:});
